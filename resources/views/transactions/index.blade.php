					...
					<div class="col-12 col-sm-6 col-xl-4 mb-2">
						...
						<div class="indTrans addBoxShadow{{ ' ' .strtolower($transaction->type) }}">
							<div class="indTransHeader">
								<h2 class=""><span class="itemContent">{{ $transaction->type }}</span><span class="indTransactionDate text-muted text-center d-block">{{ $transaction->transaction_date->format('m/d/Y') }}</span></h2>
							</div>
