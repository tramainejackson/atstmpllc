				...
				<tr>
					<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
						...
						<div style="line-height: 35px">
							...
							<p>ATSTMP<span style="color: #5caad2;">LLC</span></p>
						...
						<table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
							<tr>
								<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
									...
									<p style="line-height: 24px; margin-bottom:15px;">Hello {{ $website->owner }},</p>

									<p style="line-height: 24px;margin-bottom:15px;">This is a payment reminder for your currently active website, <a href="{{ $website->link }}">{{ $website->link }}</a>.</p>

									<table id="" class="" cellspacing="0" width="100%" style="margin-bottom: 15px;">

										<tr>
											<th class="">Expire Date<i class=""></i></th>
									...
									<a href="https://www.paypal.me/actionjack/100" style="border: solid 1px darkgray; border-radius: 5px; padding: 10px; text-decoration: none; color: whitesmoke; background-color: #1b5e20">Make Payment</a>

									<p style="line-height: 24px; margin:20px 0px;">If payment is not received by the expired date it may cause downtime for you website. For any questions please feel free to reach out to me at any time</p>
	...
	<tr>
		<td align="center" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/slide.jpg); background-size: cover; background-position: top center; background-repeat: no-repeat;"
			...
			<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
										...
										<tr>
											<td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
												...
												<div style="line-height: 26px">
													...
													<p>Big heads must mean big brains.</p>
				...
				<tr>
					<td align="center">
						<table border="0" align="center" width="250" cellpadding="0" cellspacing="0" style="">
