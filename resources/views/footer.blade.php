	...
	<div class="container text-center text-md-left">
	  ...
	  <div class="row text-center text-md-left mt-3 pb-3">
		  ...
		  <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
			  <h6 class="text-uppercase mb-4 font-weight-bold">ATSTMPLLC</h6>
			  <p>Thanks for taking the time to visit us today. We are a startup business that dibble and dabble in multiple fields. Currently doing property management, web design, and database management. If you have any questions please feel free to reach out to us.</p>
		  </div>
		  <!--/.First column-->
	  ...
	  <div class="row py-3 d-flex align-items-center">
		  ...
		  <div class="col-md-8 col-lg-8">
			  <!--Copyright-->
			  <p class="text-center text-md-left grey-text">© 2018 Copyright: <a href="http://atstmpllc.com"><strong> Atstmpllc.com</strong></a></p>
			  <!--/.Copyright-->
		  </div>
		  <!--Grid column-->
