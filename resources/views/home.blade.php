...
<div class="container-fluid">
    ...
    <div class="row">
		...
		<div class="bankAccounts col-12">
			<div class="col-md-10 col-sm-10 col-xs-10">
				<h1 class="">Banks</h1>				
			</div>
			<div class="col-md-2 col-sm-2 col-xs-2">
				<a class="btn btn-default center-block" href="/bank/create">Add A Bank</a>
			</div>
		...
		<div class="myTransactions col-12">
